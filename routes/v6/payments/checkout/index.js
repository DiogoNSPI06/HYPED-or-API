...
router.get('/', function(req, res) {
  ...
  if(isLogged !== true) return res.redirect(`https://www.hypeds.com/login?redirectTo=https://api.hypeds.com/v6/payments/checkout?productID=${req.query.productID}`);
      ...
      <div class="u-clearfix u-sheet u-valign-bottom-lg u-sheet-1">
        <div class="u-align-left u-container-style u-custom-color-1 u-expanded-width-xs u-group u-radius-20 u-shape-round u-group-1">
          <div class="u-container-layout u-valign-top-md u-valign-top-sm u-valign-top-xs u-container-layout-1">
            ...
            <a href="https://api.hypeds.com/v6/payments/checkout/pay?productID=${req.query.productID}" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-hover-palette-1-dark-1 u-radius-10 u-btn-1">IR PARA O PAGAMENTO</a>
          </div>
        </div>
...
router.get('/pay', function(req, res) {
  ...
  let paymentID = GenId(8, false, true, false)

  db.set(`HP_CurrentPayment_ID_${id}`, paymentID)
  db.set(`HP_Payment_UserID_${paymentID}`, id)
  db.set(`HP_Payment_isPaid_${paymentID}`, false)
  db.set(`HP_Payment_Product_${paymentID}`, productID)

  res.send(`<!DOCTYPE html>
<html style="font-size: 16px;" lang="en"><head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf-8">
    <meta name="keywords" content="Realize o pagamento">
    <meta name="description" content="">
    <title>HYPED | Pay</title>
    <link rel="stylesheet" href="https://beta.hypeds.com/css/HypedLibv5.css" media="screen">
    <link rel="stylesheet" href="https://www.hypeds.com/css/PayThing.css" media="screen">
    <link id="u-theme-google-font" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i|Open+Sans:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i">
  </head>
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-grey-70 u-header u-header" id="sec-011c"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="https://www.hypeds.com/login?redirectTo=https://www.hypeds.com/dashboard" class="u-active-grey-75 u-border-1 u-border-grey-30 u-border-hover-black u-btn u-btn-round u-button-style u-grey-90 u-hover-grey-80 u-radius-12 u-text-active-white u-text-hover-white u-btn-1">Login</a>
        <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1" data-responsive-from="MD">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-spacing-30 u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-border-2 u-border-active-custom-color-1 u-border-grey-90 u-border-hover-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-radius-2 u-text-active-custom-color-1 u-text-grey-90 u-text-hover-custom-color-1" href="https://www.hypeds.com" style="padding: 10px 0px;">Home</a>
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-custom-color-1 u-border-grey-90 u-border-hover-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-radius-2 u-text-active-custom-color-1 u-text-grey-90 u-text-hover-custom-color-1" href="/hypedbot" style="padding: 10px 0px;">Hyped Bot</a>
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-custom-color-1 u-border-grey-90 u-border-hover-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-radius-2 u-text-active-custom-color-1 u-text-grey-90 u-text-hover-custom-color-1" href="/hypedmusic" style="padding: 10px 0px;">Hyped Music</a>
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-custom-color-1 u-border-grey-90 u-border-hover-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-radius-2 u-text-active-custom-color-1 u-text-grey-90 u-text-hover-custom-color-1" href="/hypedhost" style="padding: 10px 0px;">Hyped Host</a>
</li><li class="u-nav-item"><a class="u-border-2 u-border-active-custom-color-1 u-border-grey-90 u-border-hover-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-radius-2 u-text-active-custom-color-1 u-text-grey-90 u-text-hover-custom-color-1" href="/hypedcloud" style="padding: 10px 0px;">Hyped Cloud</a>
</li></ul>
          </div>
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                <div class="u-menu-close"></div>
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="https://www.hypeds.com">Home</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/hypedbot">Hyped Bot</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/hypedmusic">Hyped Music</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/hypedhost">Hyped Host</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="/hypedcloud">Hyped Cloud</a>
</li></ul>
              </div>
            </div>
            <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
    ...
    <section class="u-align-center u-clearfix u-grey-75 u-section-1" id="sec-ffc4">
      <div class="u-align-left u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Realize o pagamento</h1>
        <div class="u-container-style u-grey-90 u-group u-radius-20 u-shape-round u-group-1">
          ...
          <script src="https://www.paypal.com/sdk/js?client-id=AUsVneY5DuhLH98AIY3TFEJwOyHEZL7kxK4iqdJ_Fc15JhNzINZIUW4WZxovXPABxUovnl2tFoQ_JoRk&enable-funding=venmo&currency=BRL" data-sdk-integration-source="button-factory"></script>
          <script>
              ...
              paypal.Buttons({
                ...
                createOrder: function(data, actions) {
                  return actions.order.create({
                    purchase_units: [{"description":\`${Description}\`,"amount":{"currency_code":"BRL","value": ${Value}}}]
                  });
                },
                ...
                onApprove: function(data, actions) {
                  return actions.order.capture().then(function(orderData) {
                    ...
                    actions.redirect('/a?paymentID=${paymentID}');
