...
const config = require('./checkouts/config.json')
                     ...
                     <tr> 
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:30px;color:#333333;font-size:20px">| Informações do seu pedido:</p> 
                       <ul> 
                        ...
                        <li style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;margin-left:0;color:#333333;font-size:14px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:30px;color:#333333;font-size:20px">Para: ${userNickname}</p></li> 
                       </ul></td> 
                     </tr> 
                     <tr> 
...
<html style="font-size: 16px;"><head>
    ...
    <title>HYPED | Payment Succeded</title>
...
<link rel="stylesheet" href="https://www.hypeds.com/css/PaymentSucceded.css" media="screen">
    ...
    <meta property="og:title" content="PaymentSucceded">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-grey-75 u-header u-header" id="sec-b08d"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-grey-60 u-section-1" id="sec-4676">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-border-3 u-border-grey-40 u-container-style u-grey-80 u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h2 class="u-align-center u-text u-text-1">Compra aprovada!</h2>
            <h4 class="u-text u-text-2">| @${userNickname}&nbsp;<br>
              <br>Parabéns pela sua compra de ${productName}&nbsp;
            </h4>
            <h4 class="u-text u-text-3">| Informações extras:</h4>
            <ul class="u-text u-text-4">
              <li>
                <div class="class u-list-icon"></div>O seu pedido será automaticamente processado e pode levar alguns minutos.
              </li>
              <li>
                <div class="class u-list-icon"></div>Caso ocorra algum problema, contate-nos no Discord para o resolvermos.
              </li>
            </ul>
            <a href="https://www.hypeds.com/minecraft" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-1">Voltar para a loja</a>
            <p class="u-small-text u-text u-text-default u-text-variant u-text-5">Obrigado por confiar na HYPED GROUP e seus afiliados.</p>
          </div>
        </div>
      </div>
    </section>
...
router.get('/a/:id', function(req, res) {
  ...
  db.set(`PaymentInfo_${req.params.id}`, `APROVED - ${productName} - ${productPrice}`)
  res.redirect(`https://api.hypeds.com/v5/payment/success/${req.params.id}`)
});
