              ...
              paypal.Buttons({
                ...
                onApprove: function(data, actions) {
                  return actions.order.capture().then(function(orderData) {
                    ...
                    actions.redirect('https://api.hypeds.com/v7/payments/checkout/paypal/approved?paymentID=${paymentID}');
...
router.get('/approved', function(req, res) {
  ...
  //VERIFY THE PRODUCT 
  let productID = db.get(`HP_Payment_Product_${paymentID}`)
  ...
  if(isLogged!== true) return res.redirect(`https://api.hypeds.com/v6/oauth2/login?redirectTo=https://api.hypeds.com/v7/payments/checkout/paypal/approved?productID=${productID}}`)
