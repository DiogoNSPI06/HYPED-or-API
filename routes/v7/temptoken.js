...
let config = require('./users/config.json')
...
router.get('/:apitoken/:sessid', function(req, res) {
  ...
  db.set(`Authorization_${UID}_${temptoken}5`, sessid)
  db.set(`Authorization_${UID}_${temptoken}6`, sessid)
  db.set(`Authorization_${UID}_${temptoken}7`, sessid)
